const calculator = () => {
  ...
  // Find number of additional days accrued from leap years
  ...
  // Compensate for month length variation, i.e. 28/30/31
  ...
  let mins = Math.floor(
    (hoursSinceDeath - yearsInHours - daysInHours - hours) * 60
  );
